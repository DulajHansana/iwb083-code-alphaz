    ...
    const handleLogin = () => {
        ...
        handleServerLogin({ email, password })
            .then(res => {
                if (res.user) {
                    if (res.code === 403) {
                        ...
                        setErrorMessage(res.message); // Display error message
                    } else if (res.code === 202) {
                    ...
                    setErrorMessage('Login failed: ' + res.message); // Display custom error message
            ...
            .catch((e) => {
                setIsLoading(false);
                console.log(e);
                setErrorMessage('Login failed. Please try again.'); // Display custom error message
                setIsHandlingLogin(false);
            });
    };
